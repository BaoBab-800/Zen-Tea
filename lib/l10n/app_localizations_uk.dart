...
class AppLocalizationsUk extends AppLocalizations {
  ...
  String get aniseTeaStory =>
      'Задовго до існування сучасного Єгипту насіння анісу вже цінувалося вздовж Нілу. Археологи виявили аніс серед скарбів стародавніх гробниць, що свідчить про те, що він був відомий та цінувався тисячі років тому.\n\nЗгідно з місцевими розповідями, мандрівники, які перетинали пустелю, часто брали з собою аніс, оскільки його було легко зберігати, і його можна було заварювати скрізь, де була вода. Тепла чашка анісового чаю стала заспокійливим супутником у холодні пустельні ночі.\n\nПротягом століть напій залишався популярним у єгипетських домівках. Сім\'ї подавали його гостям, ділилися ним під час розмов і передавали традицію з покоління в покоління.\n\nСьогодні анісовий чай досі насолоджується по всьому Єгипту, пов\'язуючи сучасних любителів чаю з традицією, яка сягає корінням у епоху фараонів.';
